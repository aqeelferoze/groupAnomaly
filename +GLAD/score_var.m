function [ scores, score_point] = score_var(X, Y , hyper_para, var_para )
...
score_point = var_lik_point (X,Y,hyper_para,var_para);
score_point = score_point  - quantile(score_point , cut);
score_point = logistic(score_point./RMSE(score_point)*5);
score_point = 1- score_point;
score_point = score_point*100;
%score_p  = accumarray(G_idx_glad', lik_point,[M,1]);
